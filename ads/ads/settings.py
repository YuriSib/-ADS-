...
SECRET_KEY = 'django-insecure-#vo+_*5l$mkr7^oii=4l!if$j+r-euaw@#js=*fh^*__%=u&c$'
...
TINYMCE_DEFAULT_CONFIG = {
    'plugins': 'video',  # Включаем плагин video
    'toolbar': 'video',
    # Добавляем кнопку видео на панель инструментов
}
